...
def parse_args():
    ...
    parser.add_argument('--output_root', type=str, default='../results/cmp/scienceqa')
    ...
    parser.add_argument('--test_number', type=int, default=200)  # 设置测试的数量
...
if __name__ == "__main__":
    ...
    for pid in tqdm(pids):
        ...
        extension_tools = ["solver.program_generator","solver.program_verifier","solver.program_executor","solver.row_lookup","solver.column_lookup","solver.table_verbalizer"]
        if(set(extension_tools) & set(modules)):
            print(f"modules:{modules}")
        continue  #only print sequence of modules
